...
const CartItemCard = ({ cartItem, removeFromCart }: { cartItem: CartItemShowOnCart, removeFromCart: (id: number) => void }) => {
    ...
    return (
        <>
            <div className="cart-item flex items-center bg-white p-4 rounded-md shadow-lg">
                <img src={cartItem.product.image[0]} alt="Quần Jeans Xanh" className="w-24 h-24 object-cover mr-4" />
